  ...
  <nav class="grobal-nav">
    <ul class="grobal-nav__items">
      <li class="grobal-nav__item">
        <a class="grobal-nav__link" <?php echo isset($is_home) ? "" : "href=" . $path . 'index.php#location';?>>
          はじめに
        </a>
      </li>
      <li class="grobal-nav__item">
        <a class="grobal-nav__link" <?php echo isset($is_home) ? "" : "href=" . $path . 'index.php#ivent';?>>
          体験
        </a>
      </li>
      <li class="grobal-nav__item">
  ...
  <img class="humberger-img" src="<?php echo $path; ?>images/menu.png">
    <div class="humberge__menu">
      <ul class="menu__items">
        ...
        <li class="menu__item">
          <a class="humberge__link" <?php echo isset($is_home) ? "" : "href=" .   $path . 'index.php#location';?>>
            はじめに
          </a>
        </li>
        <li class="menu__item">
          <a class="humberge__link" <?php echo isset($is_home) ? "" : "href=" . $path . 'index.php#ivent';?>>
            体験
          </a>
        </li>
        <li class="menu__item">
          <a class="humberge__link" href="<?php echo $path; ?>contact/contact.php">
            お問い合わせ
          </a>
        </li>
      </ul>
